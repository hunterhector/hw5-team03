...
public class OpennlpChunk_Type extends ComponentAnnotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.qa4mre.type.OpennlpChunk");
  ...
  public String getTag(int addr) {
      ...
      jcas.throwFeatMissing("tag", "edu.cmu.lti.qa4mre.type.OpennlpChunk");
