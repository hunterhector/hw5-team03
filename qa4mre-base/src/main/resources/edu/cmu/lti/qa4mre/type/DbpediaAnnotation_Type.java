...
public class DbpediaAnnotation_Type extends ComponentAnnotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.qa4mre.type.DbpediaAnnotation");
  ...
  public String getUri(int addr) {
      ...
      jcas.throwFeatMissing("Uri", "edu.cmu.lti.qa4mre.type.DbpediaAnnotation");
  ...
  public double getSimilarityScore(int addr) {
      ...
      jcas.throwFeatMissing("similarityScore", "edu.cmu.lti.qa4mre.type.DbpediaAnnotation");
  ...
  public int getResourceType(int addr) {
      ...
      jcas.throwFeatMissing("resourceType", "edu.cmu.lti.qa4mre.type.DbpediaAnnotation");
  ...
  public String getAbstract(int addr) {
      ...
      jcas.throwFeatMissing("abstract", "edu.cmu.lti.qa4mre.type.DbpediaAnnotation");
